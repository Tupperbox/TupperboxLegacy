module.exports = {
	...
	execute: (bot, msg, args, cfg) => {
		...
		return `Last ${cfg.lang} message sent by ${bot.recent[msg.channel.id].tulpa.name}, registered to ${user ? user.username + "#" + user.discriminator : "(unknown user " + bot.recent[msg.channel.id].user_id + ")"}`;
	}
};